...
var moreOccupations = ["Wilhelm":"Attorney", "Leonhard": "Researcher", "Henri":"Public relations"]
...
var anotherOptionalString: String? = "Howdy doo"
anotherOptionalString == nil

var anotherOptionalName: String? = "Jimbo Baggins"
anotherOptionalName == nil
if let name = anotherOptionalName {
    greeting = "Howdy doo, \(name)"
} else {
    let other = "Chimbo"
    greeting = "It's nil, \(other)"
}
